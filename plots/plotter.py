...
def _plot_reconstructed_maps(maps, name_file, center, reso=15, figsize=(15, 10)):
...
class PlotsMM:
    ...
    def plot_FMM(self, m_in, m_out, center, seenpix, nus, job_id, figsize=(12, 12), istk=1, nsig=3, name='signal'):
    ...
    def plot_FMM_mollview(self, m_in, m_out, nus, job_id, figsize=(12, 12), istk=1, nsig=3, fwhm=0):
