...
class PresetFG:
    ...
    def polarized_I(self, m, nside, polarization_fraction=0):
        ...
        polangle = hp.ud_grade(hp.read_map(os.getcwd() + '/src/data/' + 'psimap_dust90_512.fits'), nside)
        
        # Read and downgrade the depolarization map to the desired nside resolution
        depolmap = hp.ud_grade(hp.read_map(os.getcwd() + '/src/data/' + 'gmap_dust90_512.fits'), nside)
