...
from pyoperators import (BlockDiagonalOperator, ReshapeOperator, DiagonalOperator, BlockRowOperator, BlockColumnOperator, MPIDistributionIdentityOperator, PackOperator,
    ...
    def get_operator(self, A=None, gain=None, fwhm=None, seenpix=None):
        ...
        for isub in range(self.nsub):
            ...
            if fwhm is None:
                ...
                convolution = HealpixConvolutionGaussianOperator(fwhm=fwhm[isub], lmax=2*self.scene.nside)
    ...
    def get_operator(self, fwhm=None, seenpix=None):
        ...
        if seenpix is not None:
            U = (
                ...
                PackOperator(np.broadcast_to(seenpix[:, None], (seenpix.size, 3)).copy())
                ).T
        else:
            U = IdentityOperator()
